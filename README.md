...
Official SMS connector for Botpress. This module has been built to accelerate and facilitate development of SMS bots.
...
```js
botpress install sms // Not publish yet on NPM
```
...
botpress-sms is licensed under AGPLv3.
